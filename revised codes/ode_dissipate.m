...
k3 = 350 + 20*randn(n,1);
k4 = 10 + 2*randn(n,1);
k5 = 0.5*0.112 + 0.01*randn(n,1);
k6 = 0.5*0.117 + 0.02*randn(n,1);
...
hold on
plot_distribution(1000*concs, washout_mod/1.02);
hold on
plot_distribution(1000*concs, 1.06*eq_mod);
hold on
