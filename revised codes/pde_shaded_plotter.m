...
k3 = 350 + 20*randn(n,1);
k4 = 10 + 2*randn(n,1);
k5 = 0.082 + 0.02*randn(n,1);
k6 = 0.106 + 0.01*randn(n,1);
...
file_name = [save_file 'pdeuptake.png'];
...
file_name = [save_file 'pdevol.png'];
...
file_name = [save_file 'pdeintra.png'];
...
ylabel('intracellular concentration (\mu M)','fontsize',16)
file_name = [save_file 'PDEwashtimeseries.png'];
